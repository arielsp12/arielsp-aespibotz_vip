...
let info = `◪ 📮 *SCRIPT BOT*
│ *Script Aespi Botz :* 
│ ╰ https://github.com/arielsp12/arielsp-aespibotz_vip
│ *Base :* 
...
`.trim()
await conn.send2Button(m.chat, info, `🎮 Aespi Botz VIP`, '🎗 Menu', '#menu', '💌 OWNER', '.owner', ftrol)
}
handler.help = ['sc']
handler.tags = ['info']
