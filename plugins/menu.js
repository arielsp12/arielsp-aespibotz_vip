...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
 ...
 let nurt = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let mds = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let mds2 = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let admn = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

  let par = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let par2 = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let par3 = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let par4 = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let tq = `@${'6282118022072'.split('@')[0]}`

 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}

 let par6 = `@${'6282118022072'.split('@')[0]}`
...
╰━━━━━━━━━━━━━┈─ɞ
   ...
   ▌│█║▌║▌║║▌║▌║█│▌
    ...
    if (teks == '404') {
      ...
      return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        ...
        "listMessage": {
          ...
          "title": `✧────··[ Simple Menu ]··────✧`.trim(),

          "description": `${ucapan()}, ${name} !`.trim(),

          "footerText": txtmenu,

          "buttonText": "🎗 ARIEL SP GANTENG BANGET",
          ...
          "sections": [
                  ...
                  "description": "Bau Bawang Awokawok",
                  ...
                  "description": "Belajar Bro Biar Good Looking",
                  ...
                  "description": "Anjay Ariel Bohong",
                  ...
                  "description": "Bikin Stiker Sendiri Ngab",
                  ...
                  "description": "Widih Ada Editor Berkelas",
                  ...
                  "description": "Khusus Admin Group Dek",
                  ...
                  "description": "Menu Ini Khusus Group Goblog",
                  ...
                  "description": "Harus Premium Beli Gan Chat Ariel",
                  ...
                  "description": "Cari Pekob Disini Ada Ko Bro",
                  ...
                  "description": "Ngobrol Sama Hengker Tzy",
                  ...
                  "description": "Bikin Logo/Lu Mager Nugas Online",
                  ...
                  "description": "Bisa Download YT Bro",
                  ...
                  "description": "Hanya Untuk Owner Ariel SP",

                  "rowId": ".? owner"

                }],

                                "title": "「 Menu Aespi Botz 」"
                                ...
                                "description": "Tentang Update Terakhir Di Aespi Botz",
                                ...
                                "description": "Script Yang Di Pakai Ariel SP",
    ...
    conn.reply(m.chat, '*Tunggu Sedang Di Proses, Gabut Ya, Donasi Yo* https://saweria.co/arielsp *ಥ‿ಥ*', fload) 
...
function logos() {
  ...
  if (lgs >= 4) {
    ...
    imp = 'https://telegra.ph/file/a767c4edb85d3503b422b.jpg'
